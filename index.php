<?php
   ...
   // print_r($_GET);
    $pos = $_GET['pos'];  //isso fará com que, dependendo da posição 0 ou 1 que o usuário colocar na url do site, será mostrado o $pessoa correspondente. Isso está ligado ao código da linha 72.
    ...
    $pessoas[] = [
		...
		"idSigno" => 3,
		"masculino" => false,
		"descricao" => "Adoro o meu trabalho.Uso de brilhantes. Pessoa feliz.",
		"sonho" => "Ter o certificado da Digital House e o queijo da Ana Lívia",
		"amiga" => true
    ];

    //echo('<pre>');  // Isso, se descomentado, imprime na tela tudo relativo a $pessoas, ou seja, todas as pessoas existentes no código.
    //print_r($pessoas);
    //echo ('</pre>');
    //die();
    $pessoa = $pessoas[$pos]; //estamos fazendo com que a $pessoa receba a pessoa referente ao valor inserido e guardado em sua matriz( como no caso só temos 2 pessoa, só poderia ser 0 ou 1. Para isso funcionar, é necessário ter o código da linha 4.
...
<head>
    ...
    <title><?php echo $pessoa['nome'] ?>- Crush Zodíaco</title>
...
<body>
    <header style="background-image:url(./assets/img/banner-2.jpeg);">
